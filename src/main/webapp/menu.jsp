...
<html lang="en">
    ...
    <body class="text-sm layout-footer-fixed layout-navbar-fixed sidebar-mini layout-fixed" id="body"   >
        ...
        <div class="wrapper">
            ...
            <script src="js/itkv/itkv_funciones.js?v=3.6" type="text/javascript"></script>
            ...
            <script src="js/control_bidones_itkv/control_bidones_itkv.js?v=3.6" type="text/javascript"></script>
            <script src="js/registro_lluvia/registro_lluvia.js?v=3.6" type="text/javascript"></script>
            <!--para notificaciones toastr-->
