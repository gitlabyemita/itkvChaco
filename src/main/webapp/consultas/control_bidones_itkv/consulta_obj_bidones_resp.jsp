...
<%    
    ...
    try {
        ...
        rs = st.executeQuery("select * from cmb_registro_movimientos rm  left outer join cmb_presentacion pr on rm.rmov_pre_id = pr.pre_id where rm.rmov_res_id = "+res_id+" and rm.rmov_estado = '"+estado+"' order by rmov_id desc");      
